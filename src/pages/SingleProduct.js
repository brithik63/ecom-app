                ...
                <div className="row">
                    <div className="col-6">
                        ...
                        <div className="other-product-images d-flex flex-wrap gap-15">
                            <div><img src="https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-fernando-arcos-190819.jpg&fm=jpg" className='img-fluid' alt="image" /></div>
                            <div><img src="https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-fernando-arcos-190819.jpg&fm=jpg" className='img-fluid' alt="image" /></div>
                            <div><img src="https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-fernando-arcos-190819.jpg&fm=jpg" className='img-fluid' alt="image" /></div>
                            <div><img src="https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-fernando-arcos-190819.jpg&fm=jpg" className='img-fluid' alt="image" /></div>
                        </div>
                    ...
                    <div className="col-6">
                        <div className="main-product-details">
                            <div className="border-bottom">
                                <h3 className='title'>Kids Headphone Bulk 10 Pack Multi Colored For Studens</h3>
                            ...
                            <div className="py-3">
                                ...
                                <div className='d-flex  gap-10 flex-column mt-2 mb-3'>
                                    ...
                                    <div className="d-flex flex-wrap gap-15">
                                        <span className="badge border border-1 text-dark border-secondary bg-white">S</span>
                                        <span className="badge border border-1 text-dark border-secondary bg-white">M</span>
                                        <span className="badge border border-1 text-dark border-secondary bg-white">L</span>
                                        <span className="badge border border-1 text-dark border-secondary bg-white">XL</span>
                                    </div>
                                </div>
                                <div className='d-flex  gap-10 flex-column mt-2 mb-3'>
                                ...
                                <div className='d-flex align-item-center gap-15 flex-row my-2'>
                                ...
                                <div className='d-flex gap-10 flex-column my-3'>
                                    ...
                                    <p className='product-data'>
                                        Free shipping and returns on all orders! <br />  We ship all US domestic orders within <b>5-10 business days</b>
                                    </p>
                                </div>
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className='bg-white p-3'>
                            <p >
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sequi quod ipsum maiores expedita?
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="review-inner-wrapper">
                                ...
                                <div>
                                    ...
                                    <div className='d-flex align-items-center gap-10 '>
                                        <ReactStars
                                            ...
                                            edit={false}
                                            activeColor="#ffd700" />
                                        <p className='mb-0'>Based on 2 Reviws</p>
                                    </div>
                                </div>
                                {orderedProduct && (
                                    <div>
                            ...
                            <div className="reviews mt-4">
                                <div className="review">
                                    ...
                                    <p className='mt-3'>
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas laborum facere ratione velit.
                                    </p>
                                </div>
                            </div>
                        </div>
