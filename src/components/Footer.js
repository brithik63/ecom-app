      ...
      <div className="container-xxl">
        <div className="row">
          <div className="col-4">
            ...
            <div>
              <address className='text-white fs-6'>Hno : XYZ Society,
                Jammu, J & K <br />
                PinCode: 180001
              </address>
              <a href="tel:+91 9682151806" className="mt-3 d-block mb-1 text-white">
                +91 9682151806
              </a>
              <a href="mailto:britikanthal2@gmail.com" className="mt-3 d-block mb-0 text-white">
                britikanthal2@gmail.com
              </a>
          ...
          <div className="col-3">
            ...
            <div className='footer-links d-flex flex-column'>
              ...
              <Link to='/termandconditions' className='text-white py-2 mb-1'>Term & Conditions</Link>
